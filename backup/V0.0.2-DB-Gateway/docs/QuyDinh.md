Tôi muốn tạo một hệ thống máy chủ website có cấu trúc được liệt kê trong 
  QuyDinh.md để tương lai tôi có thể triển khai chạy trên nhiều máy và hiện tại 
  vẫn có thể chạy trên 1 máy
